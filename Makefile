ARKSCRIPT_VERSION := $(shell cat ARKSCRIPT_VERSION)
ARKSCRIPT_DEPS := $(wildcard ARKSCRIPT_*)
DOCKER_TAG_PREFIX := rzuckerm/arkscript:$(ARKSCRIPT_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(ARKSCRIPT_DEPS)
